...
EmuGSS_TCProgram12_5 prog_FT_0080_step_0(FT_0080_TIME_step0,"FT_SOLO_EPD_ICU_Monitoring_0080 step 0, Config PMODID 0 for monitoring PID 1",0, 1, 5, 1, 0x4000, 10, 0x4001);

EmuGSS_TCProgram12_1 prog_FT_0080_step_1(FT_0080_TIME_step1,"FT_SOLO_EPD_ICU_Monitoring_0080 step 1, Enable Monitoring PMODID 0", 0);

EmuGSS_TCProgram20_3 prog_FT_0080_step_2(FT_0080_TIME_step2,"FT_SOLO_EPD_ICU_Monitoring_0080 step 2, Update PID 1 to 99", 1, 99);

EmuGSS_TCProgram5_5 prog_FT_0080_step_3(FT_0080_TIME_step3,"FT_SOLO_EPD_ICU_Monitoring_0080 step 3, Enable RID 0x4001", 0x4001);

EmuGSS_TCProgram20_3 prog_FT_0080_step_4(FT_0080_TIME_step4,"FT_SOLO_EPD_ICU_Monitoring_0080 step 4, Update PID 1 to 5", 1, 5);

EmuGSS_TCProgram20_3 prog_FT_0080_step_5(FT_0080_TIME_step5,"FT_SOLO_EPD_ICU_Monitoring_0080 step 5, Update PID 1 to 80", 1, 80);

EmuGSS_TCProgram5_6 prog_FT_0080_step_6(FT_0080_TIME_step6,"FT_SOLO_EPD_ICU_Monitoring_0080 step 6, Disable RID 0x4001", 0x4001);

EmuGSS_TCProgram20_3 prog_FT_0080_step_7(FT_0080_TIME_step7,"FT_SOLO_EPD_ICU_Monitoring_0080 step 7, Update PID 1 to 8", 1, 8);

EmuGSS_TCProgram20_3 prog_FT_0080_step_8(FT_0080_TIME_step8,"FT_SOLO_EPD_ICU_Monitoring_0080 step 8, Update PID 1 to 40", 1, 40);
